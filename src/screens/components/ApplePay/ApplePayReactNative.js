...
const check = () => {
  paymentRequest.canMakePayments().then((canMakePayment) => {
    if (canMakePayment) {
      alert("Apple Pay", "Apple Pay is available in this device");
    } else {
        ...
        >
          ...
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
              ...
              <Button onPress={() => check()} title="Check Apple Pay" />
            </View>
          </View>
          <View style={styles.body}>
            <View style={styles.sectionContainer}>
...
export default ApplePayReactNative;
