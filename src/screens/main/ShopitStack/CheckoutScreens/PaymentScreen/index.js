...
const PaymentScreen = ({ navigation, dispatch, saving, cart }) => {
  ...
  const toggleAccordionExpanded2 = () =>
      ...
      <View style={globalStyles.containerFluid}>
        ...
        <ScrollView>
          ...
          <View style={checkoutStyles.statusBarWrapper}>
            <View style={checkoutStyles.statusBarContainer}>
              ...
              >
                <CheckO
                  size={16}
                  style={[checkoutStyles.iconStyle, { color: colors.success }]}
                />
          ...
          >
            ...
            >
              <View
                style={styles.accordionSelectorContainer}
                onPress={toggleExpanded}
              >
                <Dollar size={16} style={{ color: colors.black }} />
                <Text style={styles.accordionSelectorTitle}>
                  Pay on Delivery
                </Text>
                {expanded ? (
            ...
            <TouchableOpacity
              style={globalStyles.container}
              onPress={toggleAccordionExpanded2}
            >
            ...
            >
              <TextField
                ...
                rightElement={
                  <CreditCard size={18} style={{ color: colors.black }} />
                }
