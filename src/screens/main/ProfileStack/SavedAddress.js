            ...
            <>
              <View style={styles.addContent}>
                <View key={address.id} style={styles.addList}>
                  ...
                  <Text style={styles.addSubText}>{address.city}, {address.zipcode}</Text>
                  <Text style={styles.addSubText}>{address.country_name}</Text>
                  <Divider style={styles.divider} />
                  <View style={styles.btnGroup}>
                    <TouchableOpacity style={styles.btn} onPress={() => navigation.navigate('updateAdd')}>
                      <Text style={styles.btnText}>Update</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.btn} onPress={() => deleteAddress(address.id)}>
